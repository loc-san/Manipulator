...
*
*
* This file is C-file of the component "Manipulator".
*********************************************************************************
*/
...
*********************************************************************************
*/
void ControlCabinet::MoveManToPoint(float32 CoorX, float32 CoorY,
                                    float32 CoorZ) {
  ...
  for (size_t index = 0; index < strdAngle.size(); ++index) {
    ...
    if (m_strDatatemp.size() < 3) {
      m_strDatatemp =
          std::string(3 - m_strDatatemp.size(), '0') + m_strDatatemp;
    }
